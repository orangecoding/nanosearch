...
export const config = {
  ...
  // Automatic re-scan interval in hours. 0 (or negative/invalid) disables periodic re-indexing.
  rescanIntervalHours: Math.max(0, parseFloat(process.env.RESCAN_INTERVAL_HOURS ?? '0') || 0),
